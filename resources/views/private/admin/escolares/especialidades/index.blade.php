...
@section('content')
	<div class="row" style="margin-bottom: 0px;">
		...
		<div class="row blue white-text">
			<div class="nav-content blue col s11 offset-s1">
				<ul id="tabs_especialidades_reticulas" class="tabs tabs-transparent">
					...
					<li class="tab"><a href="#tab_reticulas" >Retúculas</a></li>
				</ul>
			</div>	
		</div>
	</div>
	...
	<div id="tab_especialidades" class="row">
		<div class="row blue white-text">
			...
			<div class="col m5 right-align hide-on-small-only">
				<a id="btn_nueva_especialidad" class="waves-effect waves-light btn center-align blue darken-2"><i class="material-icons left">add</i>Nueva especialidad</a>
			</div>	
		</div>
		<div class="col s10 offset-s1">
